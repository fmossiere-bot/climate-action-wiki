...
The rapid expansion of AI infrastructure is creating a collision between tech ambition and climate targets. **Data centres built to run AI workloads require far more power than conventional server farms** — and in both the UK and Ireland, the grid cannot keep pace with demand. The result is a growing turn towards fossil gas: not as a backup, but as a permanent primary power source. At the same time, the true carbon cost of this buildout has been systematically underestimated by governments.
...
The revised estimate: **34–123 million tonnes CO₂ over 2025–2035** — equivalent to 0.9–3.4% of the UK's projected total emissions over that period. The lower end depends on AI efficiency improvements and faster grid decarbonisation.
...
- **Drained €715 million from the Irish economy** over 2015–2023
- Added a cumulative average of **€360 to each household's electricity bill** over the same period
- Future projections: a further **€295–€644 per household** cumulatively from 2025 to 2034

The mechanism is straightforward: data centres have high and inflexible electricity demand. That demand increases the number of hours when gas sets the price in the Irish electricity market, lifting bills for all consumers. The report called this a "hidden data centre tax."
...
Similar tensions have surfaced in Ireland (see [Ireland Data Centre Dilemma](../../ireland-hub/IRELAND%20Data%20Centre%20Dilemna.md)). Between the [Slough heat-island research](../../sources/slough-datacentre-heat-island-2026.md) (electricity + waste heat) and the Water UK submission (water), the UK now has a documented three-way squeeze on grid, on households and on the water table.
...
- [AI Emissions and Corporate Responsibility](AI%20Emissions%20and%20Corporate%20Responsibility.md)
